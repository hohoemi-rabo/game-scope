...
### 4. API Route実装
- [ ] /api/twitch/streams/[gameId] 作成
- [ ] /api/twitch/clips/[gameId] 作成
- [ ] エラーハンドリングとレート制限対応
...
- [ ] getStreams関数が正常に配信情報を取得できる
- [ ] getClips関数が人気クリップを取得できる
- [ ] API Routes がエラーハンドリングを含めて動作する
- [ ] データベーススキーマ更新が完了
- [ ] レート制限に対応したリトライ機構が実装されている
- [ ] キャッシュ戦略が適切に機能する
